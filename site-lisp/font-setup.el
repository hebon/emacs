...
;; Copyright (C) 2003--2005 Yasutaka SHINDOH (新堂安孝) <ring-pub at fan.gr.jp>
...
;; Meadow 2.00 向け多言語対応フォント設定ファイル。英文と基本的な和文
;; を任意の TrueType フォントで、それ以外の文章を BDF フォントで表示し
;; ます。
...
(defun font-setup (&optional font num unuse set)
  ...
  (let ((fn (or font font-setup-ttf-def))
	...
	((:char-spec latin-iso8859-9 :height any :weight any :slant any)
	 ...
	 ((encoding . 1-byte-set-msb)))
	;; latin-iso-8859-14, 15 (Latin 8, 9 用 bdf フォントが必要)
	((:char-spec latin-iso8859-14 :height any :weight any :slant any)
	 strict
	 (bdf-font ,(expand-file-name "European/iso8859-14.bdf" dir))
	 ((encoding . 1-byte-set-msb)))
	((:char-spec latin-iso8859-15 :height any :weight any :slant any)
	 strict
	 (bdf-font ,(expand-file-name "European/iso8859-15.bdf" dir))
	 ((encoding . 1-byte-set-msb)))
...
;; 	;; indian (最新の Meadow ではコメント・アウトする必要あり)
